...
const { portalSettingsValidationSchema } = require("../modules/portal_setting/validation/portalSettingValidation");
    ...
    async getPortalSettings(req, res) {
        try {
            ...
            return res.status(200).json({
                status: true,
                message: "Portal settings has been fetched successfully.",
                data: portalSettings
            })
